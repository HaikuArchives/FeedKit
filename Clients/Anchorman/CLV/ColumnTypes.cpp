...
BTitledColumn::BTitledColumn(BMessage *archive)
	: BColumn(archive) {
	...
	archive->FindString("_title", &fTitle);
};
...
status_t BTitledColumn::Archive(BMessage *archive, bool deep = true) const {
	status_t result = BColumn::Archive(archive, deep);
	archive->ReplaceString("class", "BTitledColumn");
	archive->AddString("_title", fTitle);
...
BArchivable	*BTitledColumn::Instantiate(BMessage *archive) {
	BArchivable *instance = NULL;

	if (validate_instantiation(archive, "BTitledColumn") == true) {
		instance = new BTitledColumn(archive);
	};
...
BStringColumn::BStringColumn(BMessage *archive)
	: BTitledColumn(archive) {
	
	archive->FindInt32("_truncate", (int32 )&fTruncate);
};
...
status_t BStringColumn::Archive(BMessage *archive, bool deep = true) const {
	status_t result = BTitledColumn::Archive(archive, deep);
	archive->ReplaceString("class", "BStringColumn");
	archive->AddInt32("_truncate", fTruncate);
...
BArchivable	*BStringColumn::Instantiate(BMessage *archive) {
	BArchivable *instance = NULL;
	if (validate_instantiation(archive, "BStringColumn") == true) {
		instance = new BStringColumn(archive);
	};
...
BDateColumn::BDateColumn(BMessage *archive)
	: BTitledColumn(archive) {
};
...
status_t BDateColumn::Archive(BMessage *archive, bool deep = true) const {
	status_t result = BTitledColumn::Archive(archive, deep);
	archive->ReplaceString("class", "BDateColumn");
...
BArchivable	*BDateColumn::Instantiate(BMessage *archive) {
	BArchivable *instance = NULL;
	if (validate_instantiation(archive, "BDateColumn") == true) {
		instance = new BDateColumn(archive);
	};
...
BSizeColumn::BSizeColumn(BMessage *archive)
	: BTitledColumn(archive)
{
}
...
status_t BSizeColumn::Archive(BMessage *archive, bool deep = true) const {
	status_t result = BTitledColumn::Archive(archive, deep);
	archive->ReplaceString("class", "BSizeColumn");
...
BArchivable *BSizeColumn::Instantiate(BMessage *archive) {
	BArchivable *instance = NULL;
	if (validate_instantiation(archive, "BSizeColumn") == true) {
		instance = new BSizeColumn(archive);
	};
...
BIntegerColumn::BIntegerColumn(BMessage *archive)
	: BTitledColumn(archive) {
};
...
status_t BIntegerColumn::Archive(BMessage *archive, bool deep = true) const {
	status_t result = BTitledColumn::Archive(archive, deep);
	archive->ReplaceString("class", "BIntegerColumn");
...
BArchivable *BIntegerColumn::Instantiate(BMessage *archive) {
	BArchivable *instance = NULL;
	if (validate_instantiation(archive, "BIntegerColumn") == true) {
		instance = new BBitmapColumn(archive);
	};
...
GraphColumn::GraphColumn(BMessage *archive)
	: BIntegerColumn(archive) {
};
...
//	parent->MovePenTo(rect.left + rect.Width() / 2 - width / 2, rect.bottom - FontHeight());
	parent->MovePenTo(rect.left + rect.Width() / 2 - width / 2, graphRect.bottom - FontHeight());
	parent->DrawString(numstr);
}

//--------------------------------------------------------------------

status_t GraphColumn::Archive(BMessage *archive, bool deep = true) const {
	status_t result = BIntegerColumn::Archive(archive, deep);
	archive->ReplaceString("class", "GraphColumn");
...
BArchivable *GraphColumn::Instantiate(BMessage *archive) {
	BArchivable *instance = NULL;
	if (validate_instantiation(archive, "GraphColumn") == true) {
		instance = new GraphColumn(archive);
	};
...
BBitmapColumn::BBitmapColumn(BMessage *archive)
	: BTitledColumn(archive) {
...
status_t BBitmapColumn::Archive(BMessage *archive, bool deep = true) const {
	status_t result = BTitledColumn::Archive(archive, deep);
	archive->ReplaceString("class", "BBitmapColumn");
...
BArchivable *BBitmapColumn::Instantiate(BMessage *archive) {
	BArchivable *instance = NULL;
	if (validate_instantiation(archive, "BBitmapColumn") == true) {
		instance = new BBitmapColumn(archive);
	};
